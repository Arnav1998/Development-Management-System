	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (!firstName.isEmpty() && !lastName.isEmpty() && !email.isEmpty() && !password.isEmpty() && !phone.isEmpty()
			...
			try {
				...
				;
				String query = "INSERT INTO `users` (`id`, `firstName`, `lastName`, `email`, `password`, `phone`, `address`, `city`, `state`, `zip`, `projectId`) VALUES (NULL, '"
						+ firstName + "', '" + lastName + "', '" + email + "', '" + securedPassword + "', '" + phone
