...
<html>
	...
	<body>
		...
		<!--               </li>
		              ...
		              <li class="nav-item">
		                <a class="nav-link active" href="MeetingScheduler?email=${param.email}&key=${param.key}&projectId=${param.projectId}&projectName=${param.projectName}">
				...
				<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
					...
					<h1 class="text-center mb-0 ml-3">Meeting Scheduler</h1>
					
					<div class="card mt-2 mx-auto mb-2" style="width: 100%;">
						<div class="card-header text-white bg-danger">Warning</div>
						<div class="card-body alert alert-danger">
			  			This page will send the below entered text to all the project members in form of a text message. 
			  			</div>
					</div>
					
					<c:if test="${messageSent=='true'}">
						<div class="card mt-2 mx-auto mb-2" style="width: 100%;">
						<div class="card-header text-white bg-success">Sucess</div>
						<div class="card-body alert alert-success">
			  			Meeting has been scheduled and the project members have been notified. 
			  			</div>
					</div>
					...
					<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">						
						...
						<div class="mt-5 mx-auto border p-3 bg-light mb-3" style="width: 100%;">
							...
							<form action="MeetingScheduler" method="POST"> 
								...
								<div class="form-group">
									...
									<textarea class="form-control" rows="4" cols="50" name="textMessage" placeholder="Everyone meet at the conference hall on floor 3 at 10 am tomorrow."></textarea>
								...
								<button type="submit" class="btn btn-primary form-control">Schedule Meeting</button>
